...
namespace SCRH.Helpers
{
    ...
    public class Notification : ActionResult
    {
        ...
        public Notification(ActionResult actionResult, string message, MessageType messageType)
        {
    ...
    public static class ActionResultExtensions
    {
        ...
        {
            return new Notification(actionResult, message, Notification.MessageType.warning);
        }

        public static ActionResult Information(this ActionResult actionResult, string message)
        {
            return new Notification(actionResult, message, Notification.MessageType.info);
